...
def avg_var_missing(
    var, years, hist_dict, ave_info, file_dict, ave_type, fillValue, timer, depend, fyr
):
...
def weighted_avg_var_missing(
    ...
    if first_mask is not True:
        var_Ave[mask_sum > 0] = fillValue

    return var_Ave


def weighted_hor_avg_var_from_yr(
    var,
    reg_name,
    reg_num,
    mask_var,
...
def mean_diff_rms(
    ...
    var_RMS = weighted_rms_var_from_yr(
        var,
        reg_name,
        reg_num,
        mask_var,
