...
in_dir='tests/data/series_files/ice/'
out_dir= 'tests/output/PyAverager/ice/series/'
pref= 'test_data.cice.h'
htype= 'series'
average= ['ya:1', 'ya:2', 'ya:3', 'ya:4', 'ya:5',
            'dep_jfm:1:5','dep_fm:1:5','dep_amj:1:5','dep_jas:1:5','dep_ond:1:5','dep_on:1:5']
wght= False
spl= False
ncfrmt = 'netcdf'
serial=False
